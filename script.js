(() => {
  ...
  function createDeck() {
    ...
    for (let index = 0; index < count; index += 1) {
      ...
      card.style.setProperty("--sy", ((index * 1.2) + ((index % 4) * 0.12)) + "px");
      card.style.setProperty("--sz", (-index * 0.9) + "px");
      card.style.setProperty("--drift", drift + "px");
      card.style.setProperty("--drift-early", (drift * 0.12) + "px");
      ...
      card.style.setProperty("--spin-release", (-side * (1 + (index % 3) * 0.7)) + "deg");
      card.style.setProperty("--spin-early", (spin * 0.09) + "deg");
      card.style.setProperty("--spin-mid", (spin * 0.31) + "deg");
      card.style.setProperty("--spin-late", (spin * 0.67) + "deg");
      card.style.setProperty("--release-y", (34 + ((index * 17) % 58)) + "px");
